...
<script>
import NotificationDropdown from "@/notus/components/Dropdowns/NotificationDropdown.vue";
import UserDropdown from "@/notus/components/Dropdowns/UserDropdown.vue";
